...
def update_game(current_game_state: Dict[str, Any], game_state_manager: GameState) -> Dict[str, Any]:
    ...
    if current_state_str not in [constants.STATE_MAIN_MENU, constants.STATE_GAME_OVER]:
         # Determine cost for the *next* game based on the current mode
         is_multi = current_state_str in [constants.STATE_MULTI_POKER_WAITING_FOR_HOLD, constants.STATE_MULTI_POKER_SHOWING_RESULT]
